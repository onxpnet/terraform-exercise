...
resource "google_compute_router_nat" "onxp-bootcamp-nat" {
  ...
  nat_ips = [ google_compute_address.onxp-bootcamp-nat-address.self_link ]
...
resource "google_compute_address" "onxp-bootcamp-nat-address" {
  name = "onxp-bootcamp-nat-address"
